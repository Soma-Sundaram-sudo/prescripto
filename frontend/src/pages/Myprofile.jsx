  ...
  return userData ? (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>

     {
      ...
      {
        isedit ? <input  className="bg-gray-50 text-3xl font-medium max-w-60 mt-4" value={userData.name} type="text" onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} /> :
      ...
      <div className='grid grid-cols-[1fr_3fr] text-neutral-700 mt-3 gap-y-2.5'>
        ...
        {
          isedit ? <input className='bg-gray-100 max-w-52' value={userData.phone} type="text" onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))} /> : <p className='text-blue-400'>{userData.phone}</p>
        }
